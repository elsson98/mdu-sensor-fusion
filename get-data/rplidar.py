...
class RPLidar(object):
    ...
    def __init__(self, port, baudrate=115200, timeout=1, logger=None, rpm=666):
    ...
    def start_motor(self, motor_rpm=0):
        '''Starts sensor motor'''
